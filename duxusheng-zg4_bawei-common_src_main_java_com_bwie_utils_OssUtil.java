...
public class OssUtil {
    ...
    private static String accessKeyId = "LTAI5tChxyq88jqkTTSAmtJa";
    private static String accessKeySecret = "UGVFkh189dDp5tcgZfwG91NeMiYyak";
    private static String accessPre = "https://yunjisuan1808ash.oss-cn-shanghai.aliyuncs.com/";
    /**
     * bucket名称
     * @return
     */
    private static String bucketName = "yunjisuan1808ash";
